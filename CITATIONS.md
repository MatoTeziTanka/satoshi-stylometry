...
| C4 | First Satoshi → Hal Finney peer-to-peer transaction: 2009-01-12, block 170, 10 BTC | `[VF]` for block number, date, and amount. `[UV]` for the specific on-chain attribution to Finney via the cited `12higDjoCCNXSA95xZMWUdPvXNmkAduhWv` address | Block 170 metadata on-chain: [mempool.space/block/170](https://mempool.space/block/170) — height 170, hash `00000000d1145790a8694403d4063f323d499e655c83426834d4ce2f8dd4a2ee`, UTC timestamp 2009-01-12 03:30:25, 2 transactions (1 coinbase + 1 non-coinbase tx `f4184fc596403b9d638783cf57adfe4c75c605f6356fbc91338530e9831e9e16`), 10 BTC to a raw P2PK output. The widely-cited `12higDjoCCNXSA95xZMWUdPvXNmkAduhWv` is a P2PKH representation, not the literal on-chain output format — attribution to Finney rests on historical record (Hal Finney's own bitcointalk posts) not pure on-chain address matching |
...
| C8 | b-money proposed by Wei Dai on cypherpunks list: **1998-11-26 23:33:49**, subject "PipeNet 1.1 and b-money" | `[VF]` for the exact date | Primary source: [MARC cypherpunks archive](https://marc.info/?l=cypherpunks&m=95279516022393&w=2) returns `From: Wei Dai <weidai@eskimo.com>`, `Date: 1998-11-26 23:33:49`, `Subject: PipeNet 1.1 and b-money`. Independently corroborated by [MARC thread index](https://marc.info/?t=95279521200008&r=1&w=2) and [BibBase citation](https://bibbase.org/network/publication/dai-pipenet11andbmoney-1998) citing the same message-ID. Adam Back's reply 10 days later (1998-12-06) at [cryptoanarchy.wiki](https://mailing-list-archive.cryptoanarchy.wiki/archive/1998/12/56d10cf5f88e5d6d68797c6a3b94a25e355e561a2b8636b6b1f53bd577802fb4/) opens "Wei Dei recently announced (on cypherpunks) his 'b-money…'" — consistent with the Nov 26 post date |
| C9 | Bit Gold by Nick Szabo: canonical essay 2005-12-29; conception 1998 | `[VF]` for 2005 publication. `[VF]` for the 1998 conception year — Szabo's own self-dating | [unenumerated.blogspot.com/2005/12/bit-gold.html](https://unenumerated.blogspot.com/2005/12/bit-gold.html) for the 2005 publication. For 1998 conception: [unenumerated.blogspot.com/2011/05/bitcoin-what-took-ye-so-long.html](https://unenumerated.blogspot.com/2011/05/bitcoin-what-took-ye-so-long.html) — Szabo's own first-person statement: "although I came up with them in 1998 (at the same time and on the same private mailing list where Dai was coming up with b-money — it's a long story)". Bit gold's 1998 conception happened on a *private* mailing list, which is why no cypherpunks archive entry exists |
...
| C12 | Satoshi → Mike Hearn "moved on to other things" email: 2011-04-23 | `[VF]` for the date and quote, via Hearn-authenticated disclosure | Primary disclosure: a Bitcointalk forum user "CipherionX" published five Satoshi↔Hearn emails on Bitcointalk in 2017; Mike Hearn publicly confirmed authenticity. Hearn previously quoted excerpts on his blog `blog.plan99.net/the-resolution-of-the-bitcoin-experiment-dabb30201f7` (Jan 14 2016) but the post is JS-rendered and was not retrievable in our search. The dated quote — "I've moved on to other things. It's in good hands with Gavin and everyone." — sent Apr 23 2011, is consistent across the disclosure thread and trade-press summaries citing it (e.g. Vice's article on the CipherionX disclosure where Hearn confirmed authenticity). The date itself is therefore [VF] but rests on Hearn's published memory + the disclosure chain, not on a primary email header we retrieved directly |
...
| C15 | Hal Finney's death: 2014-08-28, in Santa Barbara CA, from ALS complications | `[VF]` for date, location, and cause | **Location correction noted**: an earlier draft of this repo asserted "Phoenix Arizona" — that was an error. Phoenix is conflated with Scottsdale AZ where Alcor performed cryopreservation; Hal Finney's actual residence and death were in Santa Barbara CA. Primary source for date and location: [Santa Barbara Independent obituary](https://www.independent.com/obits/2014/09/02/hal-finney/) (published 2014-09-02); contemporaneous trade press confirms date and ALS cause |
...
- NYT April 2026 investigation (Carreyrou et al.) implicating Adam Back as Satoshi — paywalled; we have only secondary summaries (Unchained, CoinDesk), which the repo's discipline excludes. NYT itself is trade press for this purpose, not primary forensic evidence. Adam Back has publicly denied the conclusion
